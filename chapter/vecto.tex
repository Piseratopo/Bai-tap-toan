...
\begin{enumerate}
   ...
   \item Tìm tọa độ véc-tơ $\vec{a}$ cùng phương, cùng chiều với véc-tơ $\overrightarrow{AB}$ và có độ dài bằng $3\sqrt{6}$.
\end{enumerate}

\exercise Trong không gian $Oxyz$, cho hai điểm $A(2; -1; 3)$ và $B(0; 3; 1)$.
\begin{enumerate}
   \item Tìm tọa độ điểm $C$ thuộc mặt phẳng $(Oxy)$ sao cho $\triangle ABC$ cân tại $C$ và hoành độ của $C$ bằng $3$.
